  ...
  handleSearchCity = e => {
    ...
    Promise.all([fetch(weather), fetch(forecast)])
      ...
      .then(([data1, data2]) => {
        ...
        const sunset = new Date(data1.sys.sunset * 1000).toLocaleTimeString([], { timeStyle: 'short' });
        const sunrise = new Date(data1.sys.sunrise * 1000).toLocaleTimeString([], { timeStyle: 'short' });
